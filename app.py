...
def server18():
    if request.method == 'POST':
        ...
        if PDE_type['input'] == '3DwT':
            ...
            return {'PDE_type': '2DwT', 'T': pdct_data[::21*21, 0].tolist(), 'X': pdct_data[:21*21:21, 1].tolist(), 'Y': pdct_data[:21, 2].tolist(), 'U_model': pdct_rst.tolist(), 'U_exact': exact_rst.tolist(), 'U_error': error_rst.tolist(), 'U_error_T': [np.mgrid[ipts_min_max['ipts_min_max'][0][0]:ipts_min_max['ipts_min_max'][0][1]:21j].tolist(), np.mean(error_rst, axis=(1,2)).tolist()], 'U_error_X': [np.mgrid[ipts_min_max['ipts_min_max'][1][0]:ipts_min_max['ipts_min_max'][1][1]:21j].tolist(), np.mean(error_rst, axis=(0,2)).tolist()], 'U_error_Y': [np.mgrid[ipts_min_max['ipts_min_max'][2][0]:ipts_min_max['ipts_min_max'][2][1]:21j].tolist(), np.mean(error_rst, axis=(0,1)).tolist()]}
        elif PDE_type['input'] == '2DoT':
            return {'PDE_type': '2DoT', 'X': pdct_data[::21, 0].tolist(), 'Y': pdct_data[:21, 1].tolist(), 'U_model': pdct_rst.tolist(), 'U_exact': exact_rst.tolist(), 'U_error': error_rst.tolist(), 'U_error_X': [np.mgrid[ipts_min_max['ipts_min_max'][0][0]:ipts_min_max['ipts_min_max'][0][1]:21j].tolist(), np.mean(error_rst, axis=(1,)).tolist()], 'U_error_Y': [np.mgrid[ipts_min_max['ipts_min_max'][1][0]:ipts_min_max['ipts_min_max'][1][1]:21j].tolist(), np.mean(error_rst, axis=(0,)).tolist()]}
        elif PDE_type['input'] == '1DwT':
            return {'PDE_type': '1DwT', 'T': pdct_data[::21, 0].tolist(), 'X': pdct_data[:21, 1].tolist(), 'U_model': pdct_rst.tolist(), 'U_exact': exact_rst.tolist(), 'U_error': error_rst.tolist(),  'U_error_T': [np.mgrid[ipts_min_max['ipts_min_max'][0][0]:ipts_min_max['ipts_min_max'][0][1]:21j].tolist(), np.mean(error_rst, axis=(1,)).tolist()], 'U_error_X': [np.mgrid[ipts_min_max['ipts_min_max'][1][0]:ipts_min_max['ipts_min_max'][1][1]:21j].tolist(), np.mean(error_rst, axis=(0,)).tolist()]}
        elif PDE_type['input'] == '1DoT':
            return {'PDE_type': '1DoT', 'X': pdct_data[:, 0].tolist(), 'U_model': pdct_rst.tolist(), 'U_exact': exact_rst.tolist(), 'U_error': error_rst.tolist(),  'U_error_X': [np.mgrid[ipts_min_max['ipts_min_max'][0][0]:ipts_min_max['ipts_min_max'][0][1]:21j].tolist(), error_rst.tolist()]}